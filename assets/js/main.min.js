!(function (e) {
  ...
  function (e, t, s) {
        ...
        if ("string" == typeof e) {
          ...
          if (l.indexOf("<") >= 0 && l.indexOf(">") >= 0) {
            ...
            for (
              ...
              i[a] && s.push(i[a]);
        } else if (e.nodeType || e === l || e === n) s.push(e);
    ...
    (d.fn = o.prototype), (d.Class = o), (d.Dom7 = o);
    "resize scroll".split(" ");
    const p = {
      addClass: function (e) {
      ...
      offset: function () {
        if (this.length > 0) {
          const e = this[0],
            ...
            o = e === l ? l.scrollX : e.scrollLeft;
          return { top: t.top + r - a, left: t.left + o - i };
        }
        return null;
      },
      css: function (e, t) {
        ...
        if (this.length > 0) {
          ...
          return e
            ? t.previousElementSibling && d(t.previousElementSibling).is(e)
              ? new o([t.previousElementSibling])
              : new o([])
      ...
      children: function (e) {
        ...
        for (let s = 0; s < this.length; s += 1) {
          ...
          for (let s = 0; s < a.length; s += 1)
            e
              ? 1 === a[s].nodeType && d(a[s]).is(e) && t.push(a[s])
    ...
    const h = {
        ...
        getTranslate(e, t = "x") {
          let s, a, i;
          const n = l.getComputedStyle(e, null);
          return (
            l.WebKitCSSMatrix
              ? ((a = n.transform || n.webkitTransform),
                a.split(",").length > 6 &&
                  (a = a
                    ...
                    .map((e) => e.replace(",", "."))
                    .join(", ")),
                (i = new l.WebKitCSSMatrix("none" === a ? "" : a)))
              : ((i =
                  n.MozTransform ||
                  n.OTransform ||
                  n.MsTransform ||
          ...
          for (let s = 1; s < e.length; s += 1) {
            ...
            if (null != a) {
              ...
              for (let s = 0, i = e.length; s < i; s += 1) {
                ...
                void 0 !== n &&
                  n.enumerable &&
                  (h.isObject(t[i]) && h.isObject(a[i])
                    ? h.extend(t[i], a[i])
                    : !h.isObject(t[i]) && h.isObject(a[i])
                    ? ((t[i] = {}), h.extend(t[i], a[i]))
                    : (t[i] = a[i]));
              }
            }
          }
      ...
      u = {
        touch: !!(
          "ontouchstart" in l ||
          (l.DocumentTouch && n instanceof l.DocumentTouch)
        ),
        pointerEvents:
          !!l.PointerEvent &&
    ...
    var f = {
      updateSize: function () {
        ...
        (t = void 0 !== e.params.width ? e.params.width : a[0].clientWidth),
          (s =
            void 0 !== e.params.height ? e.params.height : a[0].clientHeight),
          (0 === t && e.isHorizontal()) ||
            (0 === s && e.isVertical()) ||
            ((t =
              t -
      ...
      updateSlides: function () {
        ...
        for (let s = 0; s < c; s += 1) {
              ...
              const e = Math.floor(s / (t.slidesPerGroup * t.slidesPerColumn)),
                ...
                o =
                  0 === e
                    ? t.slidesPerGroup
                    : Math.min(
                        Math.ceil((c - e * M * t.slidesPerGroup) / M),
                        t.slidesPerGroup
                      );
              (r = Math.floor(l / o)),
                (n = l - r * o + e * t.slidesPerGroup),
                (a = n + (r * y) / M),
                i.css({
          ...
          if ("none" !== i.css("display")) {
            if ("auto" === t.slidesPerView) {
              const s = l.getComputedStyle(i[0], null),
        ...
        if (
          ...
          for (let s = 0; s < p.length; s += 1) {
            ...
            t.roundLengths && (a = Math.floor(a)),
              p[s] < e.virtualSize + p[0] && z.push(a);
          }
          p = z;
        }
        if (!t.centeredSlides) {
        ...
        if (
          ...
          0 !== t.spaceBetween &&
            (e.isHorizontal()
              ? i
                ? d.filter(f).css({ marginLeft: E + "px" })
                : d.filter(f).css({ marginRight: E + "px" })
              : d.filter(f).css({ marginBottom: E + "px" })),
      ...
      updateProgress: function (e) {
        ...
        0 === a
          ? ((i = 0), (n = !0), (r = !0))
          : ((i = (e - t.minTranslate()) / a), (n = i <= 0), (r = i >= 1)),
          h.extend(t, { progress: i, isBeginning: n, isEnd: r }),
      ...
      slideTo: function (e = 0, t = this.params.speed, s = !0, a) {
        ...
        if ((i.updateProgress(f), r.normalizeSlideIndex))
          for (let e = 0; e < o.length; e += 1)
            -Math.floor(100 * f) >= Math.floor(100 * o[e]) && (n = e);
    ...
    var w = {
      loopCreate: function () {
        ...
        for (let e = i.length - 1; e >= 0; e -= 1)
          s.prepend(d(i[e].cloneNode(!0)).addClass(t.slideDuplicateClass));
      },
      loopFix: function () {
        const e = this;
    ...
    function T(e) {
      ...
      const o = d(r.target);
      if ("wrapper" === a.touchEventsTarget && !o.closest(t.wrapperEl).length)
        return;
      if (
    ...
    function S(e) {
      const t = this,
        s = t.touchEventsData,
        { params: a, touches: i, rtlTranslate: r } = t;
      let l = e;
      ...
      if (l.preventedByNestedSwiper) return (i.startX = c), void (i.startY = p);
      if (!t.allowTouchMove)
        return (
          (t.allowClick = !1),
          void (
            s.isTouched &&
            (h.extend(i, { startX: c, startY: p, currentX: c, currentY: p }),
            (s.touchStartTime = h.now()))
          )
        );
      ...
      if (
        ...
        if (!(Math.abs(f) > a.threshold || s.allowThresholdMove))
        ...
        if (a.freeModeMomentum) {
          ...
          if (l < t.maxTranslate())
            a.freeModeMomentumBounce
              ? (l + t.maxTranslate() < -p && (l = t.maxTranslate() - p),
                (d = t.maxTranslate()),
                (c = !0),
            ...
            a.freeModeMomentumBounce
              ? (l - t.minTranslate() > p && (l = t.minTranslate() + p),
                (d = t.minTranslate()),
                (c = !0),
                (s.allowMomentumBounce = !0))
              : (l = t.minTranslate()),
            ...
            (l =
              Math.abs(o[e] - l) < Math.abs(o[e - 1] - l) ||
              "next" === t.swipeDirection
                ? o[e]
                : o[e - 1]),
              (l = -l);
          ...
          if (
            ...
            if (
              ((e = n
                ? Math.abs((-l - t.translate) / t.velocity)
                : Math.abs((l - t.translate) / t.velocity)),
              a.freeModeSticky)
            ) {
          ...
          attachEvents: function () {
            ...
            if (!u.touch && u.pointerEvents)
              ...
              if (u.touch) {
                ...
                a.addEventListener(s.start, e.onTouchStart, i),
                  a.addEventListener(
                    s.move,
                    e.onTouchMove,
                    u.passiveListener ? { passive: !1, capture: r } : r
                  ),
                  a.addEventListener(s.end, e.onTouchEnd, i),
                  s.cancel && a.addEventListener(s.cancel, e.onTouchEnd, i),
                  z || (n.addEventListener("touchstart", k), (z = !0));
              }
          ...
          setBreakpoint: function () {
            ...
            if (l && e.currentBreakpoint !== l) {
              ...
              const u = d.direction && d.direction !== i.direction,
                m = i.loop && (d.slidesPerView !== i.slidesPerView || u);
          ...
          getBreakpoint: function (e) {
            ...
            const s = Object.keys(e).map((e) => {
              if ("string" == typeof e && 0 === e.indexOf("@")) {
                ...
                return { value: l.innerHeight * t, point: e };
              }
              return { value: e, point: e };
            });
            s.sort((e, t) => parseInt(e.value, 10) - parseInt(t.value, 10));
            for (let e = 0; e < s.length; e += 1) {
              const { point: a, value: i } = s[e];
              i <= l.innerWidth && (t = a);
            }
            return t || "max";
          },
    ...
    class D extends m {
      constructor(...e) {
        ...
        a.useModulesParams(i),
          (a.params = h.extend({}, i, O, s)),
          (a.originalParams = h.extend({}, a.params)),
          (a.passedParams = h.extend({}, s)),
          (a.$ = d);
        ...
        return (
          ...
          t && t.shadowRoot && t.shadowRoot.querySelector
            ? ((r = d(t.shadowRoot.querySelector("." + a.params.wrapperClass))),
          ...
          h.extend(a, {
            ...
            touchEvents: (function () {
              ...
              return (
                ...
                u.touch || !a.params.simulateTouch
                  ? a.touchEventsTouch
    ...
    var A = { name: "device", proto: { device: E }, static: { device: E } },
      G = { name: "support", proto: { support: u }, static: { support: u } };
    const H = {
    ...
    var B = { name: "browser", proto: { browser: H }, static: { browser: H } },
      N = {
        name: "resize",
        create() {
          const e = this;
    ...
    const Y = {
      update(e) {
        ...
        (f = t.rtlTranslate ? "right" : t.isHorizontal() ? "left" : "top"),
          i
            ? ((g = Math.floor(s / 2) + a + n), (v = Math.floor(s / 2) + a + r))
            : ((g = s + (a - 1) + n), (v = a + r));
    ...
    const W = {
      ...
      enable() {
        this.keyboard.enabled ||
          (d(n).on("keydown", this.keyboard.handle),
          (this.keyboard.enabled = !0));
      },
      disable() {
        this.keyboard.enabled &&
          (d(n).off("keydown", this.keyboard.handle),
    ...
    const R = {
      ...
      handle(e) {
        ...
        if (
          ...
          !s.mouseEntered && !i[0].contains(t.target) && !a.releaseOnEdges)
        )
          return !0;
        ...
        if (a.forceToAxis)
          ...
          n =
            Math.abs(l.pixelX) > Math.abs(l.pixelY) ? -l.pixelX * r : -l.pixelY;
        if (0 === n) return !0;
    ...
    const _ = {
      update() {
        ...
        if (
          ...
          if (
            (s.dynamicBullets &&
              ...
              (l = r + (Math.min(a.length, s.dynamicMainBullets) - 1)),
              (o = (l + r) / 2)),
            a.removeClass(
        ...
        if (
          ("fraction" === s.type &&
            (i.find("." + s.currentClass).text(s.formatFractionCurrent(n + 1)),
            i.find("." + s.totalClass).text(s.formatFractionTotal(r))),
          "progressbar" === s.type)
        ) {
          let t;
          ...
          let l = 1,
            o = 1;
          "horizontal" === t ? (l = a) : (o = a),
            i
              .find("." + s.progressbarFillClass)
              .transform(`translate3d(0,0,0) scaleX(${l}) scaleY(${o})`)
              .transition(e.params.speed);
        }
        "custom" === s.type && s.renderCustom
          ? (i.html(s.renderCustom(e, n + 1, r)),
    ...
    const U = {
      ...
      setDragPosition(e) {
        ...
        (l =
          ...
          s && (l = 1 - l);
        const o =
          this.minTranslate() + (this.maxTranslate() - this.minTranslate()) * l;
      ...
      enableDraggable() {
        ...
        const {
          ...
          o = !(!u.passiveListener || !i.passiveListeners) && {
            passive: !0,
            capture: !1,
          };
        u.touch
          ? (r.addEventListener(s.start, e.scrollbar.onDragStart, l),
            r.addEventListener(s.move, e.scrollbar.onDragMove, l),
            r.addEventListener(s.end, e.scrollbar.onDragEnd, o))
          : (r.addEventListener(a.start, e.scrollbar.onDragStart, l),
            n.addEventListener(a.move, e.scrollbar.onDragMove, l),
            n.addEventListener(a.end, e.scrollbar.onDragEnd, o));
      },
      disableDraggable() {
        const e = this;
        if (!e.params.scrollbar.el) return;
        ...
        u.touch
          ? (r.removeEventListener(s.start, e.scrollbar.onDragStart, l),
            r.removeEventListener(s.move, e.scrollbar.onDragMove, l),
            r.removeEventListener(s.end, e.scrollbar.onDragEnd, o))
          : (r.removeEventListener(a.start, e.scrollbar.onDragStart, l),
            n.removeEventListener(a.move, e.scrollbar.onDragMove, l),
            n.removeEventListener(a.end, e.scrollbar.onDragEnd, o));
      },
      init() {
        const e = this;
        if (!e.params.scrollbar.el) return;
        ...
        0 === n.length &&
          ...
          i.append(n)),
          h.extend(t, { $el: i, el: i[0], $dragEl: n, dragEl: n[0] }),
    ...
    const Z = {
      ...
      onGestureStart(e) {
        const t = this,
          ...
          { gesture: i } = a;
        if (
          ((a.fakeGestureTouched = !1), (a.fakeGestureMoved = !1), !u.gestures)
        ) {
          if (
            "touchstart" !== e.type ||
          ...
          (a.fakeGestureTouched = !0),
            (i.scaleStart = Z.getDistanceBetweenTouches(e));
        }
      ...
      onTouchMove(e) {
        ...
        i.isMoved ||
          ...
          (i.startX = h.getTranslate(a.$imageWrapEl[0], "x") || 0),
          (i.startY = h.getTranslate(a.$imageWrapEl[0], "y") || 0),
      ...
      in(e) {
        ...
        if (
          ...
          return;
        let r, l, o, d, c, p, h, u, m, f, g, v, b, w, y, x, E, T;
      ...
      enable() {
        ...
        const s = !(
          ...
          a = !u.passiveListener || { passive: !1, capture: !0 },
    ...
    const Q = {
      loadInSlide(e, t = !0) {
        ...
        !i.hasClass(a.elementClass) ||
          i.hasClass(a.loadedClass) ||
          i.hasClass(a.loadingClass) ||
          (n = n.add(i[0])),
          0 !== n.length &&
            n.each((e, n) => {
              const r = d(n);
    ...
    const J = {
      ...
      setTranslate(e, t) {
        ...
        if (Array.isArray(a))
          for (let e = 0; e < a.length; e += 1)
            a[e] !== t && a[e] instanceof D && r(a[e]);
        else a instanceof D && t !== a && r(a);
      },
      setTransition(e, t) {
        const s = this,
          a = s.controller.control;
        ...
        if (Array.isArray(a))
          for (i = 0; i < a.length; i += 1)
            a[i] !== t && a[i] instanceof D && n(a[i]);
        else a instanceof D && t !== a && n(a);
      },
    };
    const ee = {
    ...
    const te = {
      ...
      setHistory(e, t) {
        ...
        let a = te.slugify(s.attr("data-history"));
        l.location.pathname.includes(e) || (a = `${e}/${a}`);
        const i = l.history.state;
        (i && i.value === a) ||
          (this.params.history.replaceState
            ? l.history.replaceState({ value: a }, null, a)
            : l.history.pushState({ value: a }, null, a));
      },
      slugify: (e) =>
        e
          .toString()
    ...
    const se = {
      ...
      init() {
        ...
        e.params.hashNavigation.watchState &&
          d(l).on("hashchange", e.hashNavigation.onHashCange);
      },
      destroy() {
        const e = this;
        e.params.hashNavigation.watchState &&
          d(l).off("hashchange", e.hashNavigation.onHashCange);
      },
    };
    const ae = {
      run() {
      ...
      setTranslate() {
        ...
        for (let e = 0; e < s.length; e += 1) {
          ...
          a % 4 == 0
            ...
            : (a - 2) % 4 == 0
            ? ((m = r + 4 * p * r), (g = r))
            : (a - 3) % 4 == 0 && ((m = -r), (g = 3 * r + 4 * r * p)),
            n && (m = -m),
            o || ((f = m), (m = 0));
          const v = `rotateX(${o ? 0 : -i}deg) rotateY(${
            o ? i : 0
          }deg) translate3d(${m}px, ${f}px, ${g}px)`;
          if (
            (u <= 1 &&
              u > -1 &&
              ((h = 90 * a + 90 * u), n && (h = 90 * -a - 90 * u)),
            t.transform(v),
            l.slideShadows)
          ) {
            let e = o
        ...
        if (
          ...
          if (o)
            ...
            const e = Math.abs(h) - 90 * Math.floor(Math.abs(h) / 90),
              ...
              n = l.shadowOffset;
            p.transform(
              `scale3d(${s}, 1, ${a}) translate3d(0px, ${i / 2 + n}px, ${
                -i / 2 / a
              }px) rotateX(-90deg)`
            );
          }
        const u = H.isSafari || H.isUiWebView ? -r / 2 : 0;
        t.transform(
    ...
    const re = {
      setTranslate() {
        ...
        for (let a = 0; a < t.length; a += 1) {
          ...
          i.transform(
            `translate3d(${o}px, ${c}px, 0px) rotateX(${l}deg) rotateY(${r}deg)`
          );
        }
      },
      setTransition(e) {
    ...
    const le = {
      setTranslate() {
        ...
        for (let e = 0, t = s.length; e < t; e += 1) {
          const t = s.eq(e),
            a = i[e],
            l = ((o - t[0].swiperSlideOffset - a / 2) / a) * n.modifier;
          let h = r ? c * l : 0,
            u = r ? 0 : c * l,
            m = -p * Math.abs(l),
            f = n.stretch;
          ...
          const b = `translate3d(${v}px,${g}px,${m}px)  rotateX(${u}deg) rotateY(${h}deg)`;
          if (
            (t.transform(b),
        ...
        if (u.pointerEvents || u.prefixedPointerEvents) {
          a[0].style.perspectiveOrigin = o + "px 50%";
        }
      },
      setTransition(e) {
        this.slides
        ...
        create() {
          h.extend(this, {
            mousewheel: {
              ...
              animateSlider: R.animateSlider.bind(this),
              releaseScroll: R.releaseScroll.bind(this),
              lastScrollTime: h.now(),
              lastEventBeforeSnap: void 0,
              recentWheelEvents: [],
            },
    ...
    void 0 === D.use &&
      ...
      D.use(de);
    new D(".js-rooms-slider", {
      slidesPerView: 1,
      spaceBetween: 30,
      breakpoints: { 768: { slidesPerView: 2 }, 960: { slidesPerView: 3 } },
      navigation: {
        nextEl: ".rooms-pagination__button--next",
        prevEl: ".rooms-pagination__button--prev",
      },
    });
    var he = document.querySelector(".js-faq");
    he.addEventListener("click", function (e) {
      var t = e.target,
        s = t.closest(".faq__item"),
        a = t.closest(".faq__headline"),
        i = ce(he.children);
      s &&
        a &&
        (s.classList.toggle("faq__item--active"),
        i.forEach(function (e) {
          e != s && e.classList.remove("faq__item--active");
        }));
    });
    var ue,
      me = document.querySelectorAll("[data-modal-trigger]"),
      fe = document.querySelectorAll("[data-modal-dismiss]"),
      ge = document.querySelector("body");
    function ve(e, t) {
    ...
    function be() {
      ve(me, function (e) {
        var t;
        (t = e.dataset.modalTrigger),
          (ue = document.querySelector(
            '[data-modal-name="' + t + '"]'
          )).classList.add("modal--active"),
          ge.classList.add("overflow");
      });
    }
    function we() {
      ve(fe, function (e) {
        !(function (e) {
          (void 0 === e || e.target.hasAttribute("data-modal-dismiss")) &&
            (ue.classList.remove("modal--active"),
            ge.classList.remove("overflow"));
        })(event);
      });
    }
    be(), we();
